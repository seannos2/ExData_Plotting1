...
# 5.  The fourth plot is generated and saved to "plot4.png"

png("Plot4.png")

par(mfrow=c(2,2))

plot(smaller$Time, smaller$Global_active_power, type ="l", ylab = paste("Global Active Power"), xlab = "")
plot(smaller$Time,smaller$Voltage, type = "l", xlab = "datetime",  ylab = "Voltage")
plot(smaller$Time,smaller$Sub_metering_1,type ="l", ylab = paste("Energy sub metering"), xlab ="")
...
plot(smaller$Time,smaller$Global_reactive_power, type = "l", xlab = "datetime",  ylab = "Global_reactive_power")
